...
| 软件 | 版本要求 | 用途 | 下载地址 |
|------|----------|------|----------|
| Node.js | >= 14.0.0 | JavaScript运行环境 | https://nodejs.org/ |
...
- GitHub仓库: https://github.com/VeganGarden/MyGarden
