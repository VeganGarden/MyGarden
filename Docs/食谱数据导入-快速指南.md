...
```
✅ 成功导入 18 道食谱
- 中式经典素食：3道（麻婆豆腐、宫保素丁、素东坡肉）
- 快手简餐：3道（凉拌黄瓜、素炒面、豆浆配油条）
- 高蛋白食谱：3道（豆腐蔬菜沙拉、黑豆藜麦碗、素食蛋白奶昔）
- 节气食谱：3道（立春春饼、冬至饺子、清明青团）
- 西式素食：3道（意大利面、披萨、罗宋汤）
- 亚洲融合：3道（寿司卷、泰式咖喱、韩式拌饭）
```
...
```json
{
  ...
  "data": {
    ...
    "byCategory": [
      ...
      {"_id": "seasonal", "count": 3},
      {"_id": "western", "count": 3},
      {"_id": "asian_fusion", "count": 3}
    ]
  }
}
```
