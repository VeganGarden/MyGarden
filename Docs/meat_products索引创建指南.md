...
- [ ] 已执行 `meat-data-import` 云函数导入 81 种肉类数据
...
- 响应时间 < 200ms
- 返回按 category 和 subcategory 的统计
...
**A**: 至少创建索引 29（name_unique），其他根据需要创建。

### Q: 创建顺序有要求吗？

**A**: 建议按 29→30→31→32 的顺序，但顺序不影响功能。
