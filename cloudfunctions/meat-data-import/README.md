...
批量导入肉类碳足迹数据到云开发数据库，为"素食vs肉食"对比计算提供基础数据支持。
...
| 分类 | 数量 | 碳足迹范围 | 示例 |
|------|------|-----------|------|
| 红肉类 | 20种 | 7-64 kg CO₂e/kg | 牛肉、羊肉、猪肉各部位 |
| 禽肉类 | 12种 | 4-7 kg CO₂e/kg | 鸡肉、鸭肉、鹅肉、火鸡 |
| 水产类 | 27种 | 3-14 kg CO₂e/kg | 鱼类、虾蟹、贝类、软体动物 |
| 加工肉类 | 15种 | 8-64 kg CO₂e/kg | 香肠、腊肉、火腿、培根 |
| 乳制品 | 7种 | 2-12 kg CO₂e/kg | 已包含在ingredients中 |
...
- 🥩 **牛肉是碳排放最高的食物**：60.5 kg CO₂e/kg（是豆腐的50倍）
- 🐑 **羊肉次之**：24.5 kg CO₂e/kg
- 🐷 **猪肉相对较低**：7.2 kg CO₂e/kg（但仍是豆腐的6倍）
